...
const Navbar = () => {
  ...
  return (
    <header className="z-50 w-full sticky bg-black text-white top-0 flex flex-col justify-between items-center py-1 lg:py-5 px-10 font-space shadow-2xl h-14 lg:h-16">
        ...
        >
          ...
          {token ? (
            ...
            <>
              ...
              <Link
                to={"/register"}
                className="bg-cyan-cornflower-blue px-5 py-1 rounded-md lg:rounded-xl shadow-lg text-blue-800 text-sm"
              >
                Sign Up
              </Link>
            </>
